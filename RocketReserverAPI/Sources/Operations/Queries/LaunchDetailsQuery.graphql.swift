...
nonisolated public struct LaunchDetailsQuery: GraphQLQuery {
  ...
  nonisolated public struct Data: RocketReserverAPI.SelectionSet {
    ...
    ///
    /// Parent Type: `Launch`
    nonisolated public struct Launch: RocketReserverAPI.SelectionSet {
      @_spi(Unsafe) public let __data: DataDict
      @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      ///
      /// Parent Type: `Mission`
      nonisolated public struct Mission: RocketReserverAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      ///
      /// Parent Type: `Rocket`
      nonisolated public struct Rocket: RocketReserverAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
